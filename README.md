...
1. **Terraform Repository**: [CapstoneProject-Terraform](https://github.com/Lucky-Hero-Vired-Projects/Project-1.git)
   - Responsible for provisioning the required cloud infrastructure.

2. **Kubernetes Repository**: [CapstoneProject-Kubernetes](https://github.com/Lucky-Hero-Vired-Projects/Project-1.git)
